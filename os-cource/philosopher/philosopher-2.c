 ...
 * @Author: NiGo
 * @LastEditors: NiGo
 * @Date: 2021-10-14 20:51:59
 * @LastEditTime: 2021-10-14 21:16:51
 * @Description: file content
 * @FilePath: /os-cource/philosopher/philosopher-2.c
 */
...
int main(int argc, char *argv[]) {
  ...
  for (int i = 0; i < PHILOSOPHER_NUM; i++) {
    if (i % 2) {
      pthread_create(&threads[i], NULL, PhilosopherOdd, (void *)(long)i);
    } else {
      pthread_create(&threads[i], NULL, PhilosopherEven, (void *)(long)i);
    }
  }
